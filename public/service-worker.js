...
const staticFileCacheName = "static-files-v-0xbcy2ye7y3ubfhwvdtw1tye984it0y45plmlplalkom";
...
self.addEventListener("push", (event) => {
  const payload = event.data?.json() || { title: "Test Push", body: "Hello from localhost!" };
